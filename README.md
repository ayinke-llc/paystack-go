[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ayinke-llc/paystack-go) [![Build Status](https://travis-ci.org/ayinke-llc/paystack-go.svg?branch=master)](https://travis-ci.org/ayinke-llc/paystack-go) 
...
``` go
import "github.com/ayinke-llc/paystack-go"

apiKey := "sk_test_fjfhf"
